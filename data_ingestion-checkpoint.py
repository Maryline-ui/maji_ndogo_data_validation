""" data_ingestion.py
This module provides functions to ingest and process data into DataFrames for field, weather, and weather mapping data.
It is designed to handle data extraction and transformation for further analysis or storage. """
from sqlalchemy import create_engine, text
import logging
import pandas as pd
# Name our logger so we know that logs from this module come from the data_ingestion module
""" Importing data_ingestion.py """
